...
public class CXResources {
	...
	public static final class drawable{
		...
		public static final int bx_header_line = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_header_line");
		public static final int bx_btn_more_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "bx_btn_more_selector");
		public static final int bx_btn_game_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_game_selector");
		public static final int bx_btn_html_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_html_selector");
		public static final int bx_head_setting_icon_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_head_setting_icon_selector");
		public static final int bx_head_news_icon_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_head_news_icon_selector");
		public static final int bx_head_game_icon_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_head_game_icon_selector");
		public static final int bx_head_text_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_head_text_selector");
		public static final int bx_btn_alipay_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_alipay_selector");
		public static final int bx_btn_dx_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_dx_selector");
		public static final int bx_btn_jw_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_jw_selector");
		public static final int bx_btn_jy_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_jy_selector");
		public static final int bx_btn_lt_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_lt_selector");
		public static final int bx_btn_qq_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_qq_selector");
		public static final int bx_btn_sd_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_sd_selector");
		public static final int bx_btn_wm_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_wm_selector");
		public static final int bx_btn_wy_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_wy_selector");
		public static final int bx_btn_yd_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_yd_selector");
		public static final int bx_btn_sj_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_yl_selector");
		public static final int bx_btn_yl_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_yl_selector");
		public static final int bx_btn_yl_voice_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_yl_voice_selector");
		public static final int bx_btn_zt_selector = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_zt_selector");
		...
		public static final int cx_btn_selector_3 = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_selector_3");
		public static final int cx_btn_selector_2 = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_selector_2");
		public static final int cx_btn_selector_1 = Util.getResIdFromFileName(context, TYPE_DRAWABLE, "cx_btn_selector_1");
	...
	public static final class layout{
		...
		public static final int bx_quick_play_vertical = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_quick_play_vertical");
		public static final int bx_account_register = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_account_register");
		public static final int bx_account_register_vertical = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_account_register_vertical");
		public static final int bx_find_password = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_find_password");
		public static final int bx_find_new_password = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_find_password");
		public static final int bx_find_new_password_vertical = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_find_password_vertical");
		public static final int bx_reset_password = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_reset_password");
		public static final int bx_set_new_password = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_set_new_password");
		public static final int bx_set_new_password_vertical = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_set_new_password_vertical");
		public static final int bx_force_change_password = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_force_change_password");
		public static final int bx_user_setting_panel = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_user_setting_panel");
		public static final int bx_bind_phone = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_bind_phone");
		public static final int bx_bind_phone_vertical = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_bind_phone_vertical");
		public static final int bx_change_password = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_change_password");
		public static final int bx_change_bind_phone = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_change_bind_phone");
		public static final int bx_bind_phone_again = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_bind_phone_again");
		public static final int bx_payment = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_payment");
		public static final int bx_payment_by_alipay = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_payment_by_alipay");
		public static final int bx_pay_grid_item = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_pay_grid_item");
		public static final int bx_payment_ending = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_payment_ending");
		public static final int bx_dialog_download_tip = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_dialog_download_tip");
		public static final int bx_payment_web = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_payment_web");
		public static final int bx_tip_dialog = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_tip_dialog");
		public static final int bx_pay_center_transaction_dialog = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_pay_center_transaction_dialog");
		public static final int bx_pay_center = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_pay_center");
		public static final int bx_pay_center_vertical = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_pay_center_vertical");
		public static final int bx_pay_center_game_card_item = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_pay_center_game_card_item");
		public static final int bx_pay_center_transaction = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_pay_center_transaction");
		public static final int bx_pay_center_transaction_records_item = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_pay_center_transaction_records_item");
		public static final int bx_alipay = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_alipay");
		public static final int bx_alipay_dialog_alert = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_alipay_dialog_alert");
		public static final int bx_webview = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_webview");
		public static final int bx_account_info = Util.getResIdFromFileName(context, TYPE_LAYOUT, "cx_account_info");
	}
	...
	public static final class id{
		...
		public static final int bx_home_password_text = Util.getResIdFromFileName(context, TYPE_ID, "bx_home_password_text");
		...
		public static final int cx_home_register = Util.getResIdFromFileName(context, TYPE_ID, "cx_home_register");
		public static final int bx_home_other_qq = Util.getResIdFromFileName(context, TYPE_ID, "bx_home_other_qq");
		public static final int bx_home_other_xinlang = Util.getResIdFromFileName(context, TYPE_ID, "bx_home_other_xinlang");
		...
		public static final int bx_register_sec_password = Util.getResIdFromFileName(context, TYPE_ID, "bx_register_sec_password");
		...
		public static final int bx_home_account_text = Util.getResIdFromFileName(context, TYPE_ID, "bx_home_account_text");
