...
public class Result {
	...
	public  void parseResult(String publicKey) {
		...
		try {
			...
			isSignOk = checkSign(result,publicKey);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	private  boolean checkSign(String result,String publicKey) {
...
//				retVal = Rsa.doCheck(signContent, sign, Keys.PUBLIC);
				retVal = Rsa.doCheck(signContent, sign, publicKey);
			}
		} catch (Exception e) {
			e.printStackTrace();
